                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="type" class="form-control">
                            ...
                            <option value="2">Chỉ hiển thị banner, không có nội dung</option>
                            <option value="3">Hiển thị nội dung, không hiển thị banner</option>
                          </select>
                      </div>
                </div>
            </div>
                    ...
                    <tr>
                      ...
                      <td style="width:30%">
                          <div class="banner--img">
                            <img src="{{$item->banner}}" alt="banner{{$index++}}">
                          </div>
                      </td>
                      <td>

                      <a class="btn btn-warning" href="{{route('admin.banner.edit',$item->id)}}">
