...
@section('title', __('Giới hạn truy cập'))
@section('code')
Phân quyền
@endsection
@section('message')
...
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
  ...
  <g>
    ...
    <text opacity="0.6" x="15" y="257" fill="#000" font-family="Arial" font-size="25">Liên kết đã bị chặn
      <tspan x="35" y="292" >bạn không thể vào!</tspan>
      <tspan x="100" y="357" fill="#000" font-size="65">403</tspan>
      <tspan x="93" y="381.2" fill="#000" font-size="15">Không được quyền vào đây</tspan>
    </text>

    <text x="15" y="255" fill="#6BA184" font-family="Arial" font-size="25">Liên kết đã bị chặn
      <tspan x="35" y="290" >bạn không thể vào!</tspan>
      <tspan x="100" y="355" fill="#BF3E73" font-size="65">403</tspan>
      <tspan x="93" y="380" fill="#6BA184" font-size="15">Không được quyền vào đây</tspan>
    </text>
  </g>
  </g>
</g>
