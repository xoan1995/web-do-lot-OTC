...
<main class="neu">
    <div class="container">
                                ...
                                <div class="col-md-4 col-lg-3">
                                    <div class="neu__menu_search__item_1">
                                        ...
                                        <div class="neu__menu_search__item_1__form_search">
                                                <form method="POST" action="{{route('searchCategry',$categories->slug)}}" class="neu__menu_search__item__size__label_search">
                                                    @csrf
                                                    @method('POST')
                        ...
                        <div class="row">
                            <div class="col-6 col-md-6 col-lg-6">
                                <div class="neu__list_product__general_information__text">
                                        <span>{{count($categories->product)}} Product</span>
                                </div>
                            </div>
                            {{-- <div class="col-6 col-md-6 col-lg-6">
        ...
        <section class="neu__list_product" id="accordionExample">
            @foreach ($categories->product->chunk(4) as $chunk)
                                                                        ...
                                                                        <div class="productshow__modal--carousel">
                                                                            ...
                                                                            <div class="productshow__modal--carousel__slider">
                                                                                    @foreach ($categories->product as $item)
                                                                                        <div>
                                                                                            <a href="{{url($categories->slug.'/chi-tiet/'.$item->slug)}}" class="productshow__modal--carousel__slider--component">
